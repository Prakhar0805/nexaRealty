...
const RayaHeritageCity = () => {
  const { properties, loading } = useProperties("raya-heritage-city");
        ...
        <section className="section-container section-padding">
          <div className="max-w-3xl mx-auto text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground animate-fade-up" style={{ animationDelay: "0.1s" }}>
              Plotted developments and mixed-use land banks in the Raya Heritage City belt.
            </p>
          </div>
...
export default RayaHeritageCity;
