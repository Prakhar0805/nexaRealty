...
const InstitutionalPlots = () => {
  const { properties, loading } = useProperties("institutional-plots");
        ...
        <section className="section-container section-padding">
          <div className="max-w-3xl mx-auto text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground animate-fade-up" style={{ animationDelay: "0.1s" }}>
              Approved institutional land for schools, colleges and training centres.
            </p>
          </div>
...
export default InstitutionalPlots;
