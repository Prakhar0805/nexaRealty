...
const MedicalDevicesPark = () => {
  const { properties, loading } = useProperties("medical-devices-park");
        ...
        <section className="section-container section-padding">
          <div className="max-w-3xl mx-auto text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground animate-fade-up" style={{ animationDelay: "0.1s" }}>
              Specialised plots in upcoming medical devices and healthcare parks.
            </p>
          </div>
...
export default MedicalDevicesPark;
